...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/saphanareceiver v0.89.0
...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/httpprovider v1.59.0 // indirect
